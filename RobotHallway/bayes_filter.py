...
class BayesFilter:
    ...
    def reset_probabilities(self, n_bins: int = 10):
        ...
        # YOUR CODE HERE
        self.probabilities = n_bins * [1.0 / n_bins]
    ...
    def update_belief_sensor_reading(self, world_ground_truth, robot_sensor, sensor_reading):
        ...
        for i, p_x in enumerate(self.probabilities):
            ...
            if door:
                p_y_x = robot_sensor.door_sensor_probabilities["door"][sensor_reading]
            else:
                p_y_x = robot_sensor.door_sensor_probabilities["no_door"][sensor_reading]
